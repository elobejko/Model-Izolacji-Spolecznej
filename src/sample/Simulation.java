...
public class Simulation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Symulacja: 1.000 elementów, 2 opinie, 1 wymiarów");
		symulacja.save();
		//"Szybka" generacja danych
		/**symulacja = new Simulation(10000,2,1);
		System.out.println("Symulacja: 10.000 elementów, 2 opinie, 1 wymiar");
		symulacja.save();
		symulacja = new Simulation(100000,2,1);
		System.out.println("Symulacja: 100.000 elementów, 2 opinie, 1 wymiar");
		symulacja.save();
		symulacja = new Simulation(1000000,2,1);
		System.out.println("Symulacja: 1000.000 elementów, 2 opinie, 1 wymiar");
		symulacja.save();
		symulacja = new Simulation(100,2,100);
		System.out.println("Symulacja: 100 elementów, 2 opinie, 100 wymiarów");
		symulacja.save();
		symulacja = new Simulation(1000,2,100);
		System.out.println("Symulacja: 1.000 elementów, 2 opinie, 100 wymiarów");
		symulacja.save();
		symulacja = new Simulation(10000,2,100);
		System.out.println("Symulacja: 10.000 elementów, 2 opinie, 100 wymiarów");
		symulacja.save();
		symulacja = new Simulation(10000,5,1);
		System.out.println("Symulacja: 10.000 elementów, 5 opinii, 1 wymiar");
		symulacja.save();
		symulacja = new Simulation(10000,10,1);
		System.out.println("Symulacja: 10.000 elementów, 10 opinii, 1 wymiar");
		symulacja.save();
		symulacja = new Simulation(10000,100,1);
		System.out.println("Symulacja: 10.000 elementów, 100 opinii, 1 wymiar");
		symulacja.save();**/
	}
}
